...
| **SE (standard error)** | How *precise* that estimate is. Ask: "if I repeated this whole study with a fresh sample of 150 people, how much would this number wobble?" Small SE = we've pinned the number down tightly; big SE = it's fuzzy. |
...
-   Dataset:
    [**hr_vo2.omv**](https://lms.griffith.edu.au/courses/32192/files/9303275?wrap=1)
...
$$\hat{y} = 83.727 - 0.575 \times 60 = 83.73 - 34.50 = 49.23 \text{ mL/kg/min}$$

A resting HR of 60 bpm predicts a VO₂max of about **49 mL/kg/min**.
(Small print: if you rounded the slope to −0.58 you’d get ≈ 49.93, 
that’s from rounding, not an error.) Two health warnings on every prediction:
